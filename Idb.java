...
class Icdb {
    public void create() {
        try {
            ...
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/internshipjava", "root", "");
    ...
    public void insert() {
        ...
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/internshipjava", "root", "");
